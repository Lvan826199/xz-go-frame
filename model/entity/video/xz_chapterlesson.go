...
type XkVideoChapterLesson struct {
	...
	VideoId         string `gorm:"size:60;not null;default:'';comment:播放视频ID" json:"videoID"`
	VideoInfo       string `gorm:"size:1000;not null;default:'';comment:视频的相关信息" json:"videoInfo"`
